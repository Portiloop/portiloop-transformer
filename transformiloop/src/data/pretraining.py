...
def read_patients_info(dataset_path:str)->dict[str,dict[str,int|str|ndarray]]:
    """
...
def read_pretraining_dataset(dataset_path:str, patients_to_keep:list[str]=None)->dict[str,dict[str,int|str|ndarray]]:
    """
